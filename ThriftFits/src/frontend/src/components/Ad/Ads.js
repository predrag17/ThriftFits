            ...
            {ads.slice().length !== 0 ? (
                <div className="container-fluid" style={{marginTop: "150px"}}>
                                        ...
                                        <form onSubmit={handleSubmit}>
                                            ...
                                            <div className="form-group" style={{marginBottom: "10px"}}>
                                                ...
                                                >
                                                    ...
                                                    <option style={{color: "yellow", backgroundColor: "yellow"}}>Yellow
                                                    </option>
                                                    <option style={{color: "orange", backgroundColor: "orange"}}>Orange
                                                    </option>
                                                    <option style={{color: "purple", backgroundColor: "purple"}}>Purple
                                                    </option>
                                                    ...
                                                    <option style={{color: "maroon", backgroundColor: "maroon"}}>Maroon
                                                    </option>
                                                    ...
                                                    <option
                                                        style={{color: "magenta", backgroundColor: "magenta"}}>Magenta
                                                    </option>
                                                    <option style={{color: "teal", backgroundColor: "teal"}}>Teal
                                                    </option>
                                                    <option style={{color: "indigo", backgroundColor: "indigo"}}>Indigo
                                                    </option>
                                                </select>
                                            </div>
                                    ...
                                    <div>
                                        ...
                                        <form onSubmit={handleSortSubmit}>
                                            <div className="form-group d-flex align-items-center justify-content-start"
                                                ...
                                                />
                                                <label className="form-check-label" htmlFor="newestCheckbox" style={{
                                                    fontSize: '22px',
                                                    marginTop: '5px',
                                                    marginLeft: '5px'
                                                }}>Newest</label>
                                            ...
                                            <div className="form-group d-flex align-items-center justify-content-start"
                                                ...
                                                />
                                                <label className="form-check-label" htmlFor="oldestCheckbox" style={{
                                                    fontSize: '22px',
                                                    marginTop: '5px',
                                                    marginLeft: '5px'
                                                }}>Oldest</label>
                    ...
                    {location.pathname === "/search" && (
                        <h1 style={{textAlign: "center", fontWeight: "bold", marginBottom: "50px"}}> Searched Ads!</h1>
                    )}
